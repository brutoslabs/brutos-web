...
import org.brandao.brutos.annotation.helper.any.app2.fail.Test10FailAnyController;
import org.brandao.brutos.annotation.helper.any.app2.fail.Test1FailAnyController;
import org.brandao.brutos.annotation.helper.any.app2.fail.Test2FailAnyController;
import org.brandao.brutos.annotation.helper.any.app2.fail.Test3FailAnyController;
import org.brandao.brutos.annotation.helper.any.app2.fail.Test4FailAnyController;
import org.brandao.brutos.annotation.helper.any.app2.fail.Test5FailAnyController;
import org.brandao.brutos.annotation.helper.any.app2.fail.Test6FailAnyController;
import org.brandao.brutos.annotation.helper.any.app2.fail.Test7FailAnyController;
import org.brandao.brutos.annotation.helper.any.app2.fail.Test8FailAnyController;
import org.brandao.brutos.annotation.helper.any.app2.fail.Test9FailAnyController;
import org.brandao.brutos.annotation.helper.any.app2.fail.metavaluesdefinition.Test1FailAnyMetaValuesDefinitionController;
import org.brandao.brutos.annotation.helper.any.app2.fail.metavaluesdefinition.Test2FailAnyMetaValuesDefinitionController;
import org.brandao.brutos.annotation.helper.any.app2.fail.metavaluesdefinition.Test3FailAnyMetaValuesDefinitionController;
import org.brandao.brutos.annotation.helper.any.app2.fail.metavaluesdefinition.Test4FailAnyMetaValuesDefinitionController;
import org.brandao.brutos.annotation.helper.any.app2.fail.metavaluesdefinition.Test5FailAnyMetaValuesDefinitionController;
...
public class AnyElementCollectionFailTest extends TestCase{
        ...
        WebApplicationContextTester.run(
            ...
            new WebApplicationTester() {
                ...
                public void checkResult(HttpServletRequest request, HttpServletResponse response, 
                    ...
                    Assert.fail("expected: {meta values not found}");
                }
                ...
                public void checkException(Throwable e) throws Throwable {
                    ...
                    Throwable ex = e;
                    do{
                        if(ex.getMessage().equals("meta values not found"))
                            return;
    ...
    public void testTest3FailAnyController() throws Throwable{
        WebApplicationContextTester.run(
            ...
            new WebApplicationTester() {
                ...
                public void checkResult(HttpServletRequest request, HttpServletResponse response, 
                        ServletContext context, ConfigurableWebApplicationContext applicationContext) {
                    Assert.fail("expected: {undefined meta bean}");
                }
                ...
                public void checkException(Throwable e) throws Throwable {
                    ...
                    Throwable ex = e;
                    do{
                        if(ex.getMessage().equals("undefined meta bean"))
                            return;
                    }while((ex = ex.getCause()) != null);
