...
public class KeyEntry implements BeanEntry {
	...
	public KeyEntry(Class<?> classType, Type genericType,
			KeyCollection definition, Annotation[] annotation) {
		...
		if (definition != null) {
			...
			this.temporal = StringUtil.isEmpty(definition.temporal()) ? null
