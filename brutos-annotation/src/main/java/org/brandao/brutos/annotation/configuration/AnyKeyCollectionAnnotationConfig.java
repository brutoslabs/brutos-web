...
public class AnyKeyCollectionAnnotationConfig extends AbstractAnnotationConfig {
	...
	public boolean isApplicable(Object source) {
		return source instanceof KeyEntry &&
				((KeyEntry)source).isAnnotationPresent(AnyKeyCollection.class);
	}
	...
	public Object applyConfiguration0(Object source, Object builder,
        ...
        this.buildMetaValues(anyKeyCollection, metaBeanBuilder, 
        		keyBuilder.getBeanBuilder().getControllerBuilder(), componentRegistry);
    ...
    private void buildMetaValues(AnyKeyCollection any, MetaBeanBuilder metaBeanBuilder, 
